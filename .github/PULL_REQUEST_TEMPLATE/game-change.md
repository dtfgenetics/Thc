...
- Game:
- Canonical source path/repository:
- Public route affected:
- Change type: feature / fix / content / balance / multiplayer / deployment
...
- [ ] I did not create a duplicate implementation of a game owned by another canonical repository.

### Production notes

- Deployment workflow required:
- Live route(s) to verify after deployment:
