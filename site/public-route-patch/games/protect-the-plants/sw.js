const CACHE='ptp-shell-v4-burn-buds-placement-targeting-20260904';
const SHELL=['./','./index.html','./styles.css','./visual-fixes.css','./enhancements.css','./v2-extras.css','./burn-buds.css','./gameplay-v3.css','./placement-v1.css','./targeting-v1.css','./app.js','./enhancements.js','./v2-extras.js','./burn-buds-branding.js','./gameplay-v3.js','./combat-a11y-v1.js','./placement-v1.js','./targeting-v1.js','./plant.svg','./manifest.webmanifest'];
