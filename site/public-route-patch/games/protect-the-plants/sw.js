const CACHE='ptp-shell-v3-burn-buds-a11y-20260828';
const SHELL=['./','./index.html','./styles.css','./visual-fixes.css','./enhancements.css','./v2-extras.css','./burn-buds.css','./gameplay-v3.css','./app.js','./enhancements.js','./v2-extras.js','./burn-buds-branding.js','./gameplay-v3.js','./combat-a11y-v1.js','./plant.svg','./manifest.webmanifest'];
