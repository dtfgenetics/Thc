...
- Source versions reviewed:
  - Volume 09 v1.0 controlled manuscript
  - THC Encyclopedia Verification and Crosswalk Workbook v2.0 — Volume 09 Intake
  - PR #123 candidate lesson records
...
- [ ] `REVISE BEFORE PUBLICATION` — list required edits below.
- [ ] `HOLD` — evidence or safety gap remains.

Release-time controls / required edits:

Reviewer signature or authenticated review record:
