...
for (const token of ['data-atlas-mode','data-atlas-layer','data-atlas-command-input','plant-atlas:focus','wireWorkspaceChrome','wireStageAndCompare','setStage','renderCompare','data-rail-toggle','data-viewer-action','atlasLabels','data-compare-assign','data-layer-legend','scale-map-v1.json','media-registry-v1.json','data-atlas-scale-nav','data-atlas-media-panel','atlas-media-gallery','mediaCoverage','decorateMediaCoverage','data-media-coverage-badge','atlas-media-dialog','atlas-media-evidence','atlas-evidence-meta','data-media-asset-id','data-media-state','data-scale-direction','Go deeper','metaKey','ctrlKey','Measurements','Evidence']) ok(workspaceRuntime.includes(token), `Atlas V5 workspace runtime missing: ${token}`);
