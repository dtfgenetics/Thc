...
@media(max-width:980px){.v3 .hero-grid,.v3 .topic-hero,.v3 .primary-grid,.v3 .split{grid-template-columns:1fr}.v3 .reference-desk{grid-template-columns:repeat(2,minmax(0,1fr))}.v3 .quick-reference{grid-template-columns:repeat(2,minmax(0,1fr))}.v3 .path-grid,.v3 .ref-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.v3 .release-grid,.v3 .all-subjects,.v3 .visual-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.v3 .lesson-grid{grid-template-columns:1fr}.v3 .heading{align-items:flex-start;flex-direction:column}.v3 .feature{min-height:360px}}
@media(max-width:620px){.v3 .wrap{width:min(100% - 28px,1200px)}.v3 .reference-desk,.v3 .quick-reference{grid-template-columns:1fr}.v3 .hero{padding:52px 0 45px}.v3 h1{font-size:clamp(2.5rem,14vw,4rem)}.v3 .section{padding:52px 0}.v3 .path-grid,.v3 .ref-grid,.v3 .release-grid,.v3 .all-subjects,.v3 .visual-grid{grid-template-columns:1fr}.v3 .actions .v3-btn{width:100%}.v3 .hero-media:before{display:none}.v3 .feature{min-height:330px}}
</style>`;
