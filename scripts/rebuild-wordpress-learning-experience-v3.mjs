...
function buildTopic(topic) {
  ...
  <section class="section"><div class="wrap"><div class="heading"><div><p class="eyebrow">Use the subject</p><h2>Read with an observation framework.</h2></div><p>The same four questions keep the literature practical without pretending one symptom, number, or photograph proves a cause.</p></div><div class="quick-reference"><article><strong>Observe</strong><p>Where is the pattern, what tissue is affected, and how is it changing?</p></article><article><strong>Measure</strong><p>Which environmental, root-zone, light, water, or timing measurement actually tests the question?</p></article><article><strong>Compare</strong><p>What alternative explanation would produce a similar pattern, and what evidence separates them?</p></article><article><strong>Record</strong><p>Save the measurement, image, intervention, and response so the conclusion can be checked later.</p></article></div><div class="reference-desk">${tools}</div></div></section>
