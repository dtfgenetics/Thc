...
body.woocommerce-shop .woocommerce-ordering select,body.post-type-archive-product .woocommerce-ordering select{min-height:44px;border:1px solid #bfd0c3;border-radius:999px;background:#fff;padding:8px 38px 8px 14px;color:var(--dtf-shop-ink);font-weight:750;box-shadow:0 8px 22px rgba(18,49,29,.06)}
