...
const course = (c, index) => `<details class="av2-course" data-av2-course="${esc(c.id)}" id="av2-${esc(c.id)}"${index===0?' open':''}><summary class="av2-course-summary"><div><small>Course ${String(c.number).padStart(2,'0')}</small><h3>${esc(c.title)}</h3><p>${esc(c.purpose)}</p></div><span class="av2-course-toggle" aria-hidden="true">+</span></summary><div class="av2-course-body"><div class="av2-course-actions"><a href="${esc(c.route)}">Open V6 subject →</a></div><aside class="av2-boundary"><b>Evidence boundary</b><span>${esc(c.evidenceBoundary)}</span></aside><div class="av2-units">${c.units.map(unit).join('')}</div><div class="av2-practice">${c.exercises.map(exercise).join('')}<article class="av2-capstone"><small>Course capstone</small><h4>Show that you can use the system</h4><p>${esc(c.capstone)}</p></article></div><details class="av2-check"><summary>Completion checklist</summary><ul>${c.completion.map(x=>`<li>${esc(x)}</li>`).join('')}</ul></details></div></details>`;
...
const css = `<style id="dtf-academy-v2-style">body.page-id-${page.id} .entry-title,body.page-id-${page.id} .wp-block-post-title,body.page-id-${page.id} header.entry-header>h1{display:none!important}.av2{--d:#102115;--g:#3f733f;--gold:#d8bd73;--bg:#f6f5ed;--p:#fffdf8;--ink:#213626;--muted:#5c6b5e;--line:#dce3d8;background:linear-gradient(180deg,#f8f5ea,#eef4ea);color:var(--ink);padding:68px 0 82px}.av2 *{box-sizing:border-box}.av2-wrap{width:min(1200px,calc(100% - 34px));margin:auto}.av2 small{display:block;color:#806d32;font-weight:950;letter-spacing:.1em;text-transform:uppercase;margin-bottom:6px}.av2 h2{font-size:clamp(2.5rem,5vw,4.7rem);line-height:.96;letter-spacing:-.05em;margin:0}.av2 h3{font-size:clamp(1.9rem,3.4vw,2.9rem);line-height:1;letter-spacing:-.035em;margin:0}.av2 h4{margin:0 0 8px}.av2 p{color:var(--muted);line-height:1.65}.av2-hero{display:grid;grid-template-columns:1.1fr .9fr;gap:26px}.av2-stats{display:grid;grid-template-columns:repeat(2,1fr);gap:18px;background:linear-gradient(145deg,var(--d),#29482a);border-radius:24px;padding:24px;color:white}.av2-stats b{display:block;color:var(--gold);font-size:2.25rem}.av2-rules{margin:28px 0;padding:22px;background:white;border:1px solid var(--line);border-radius:20px}.av2-rules ol{columns:2;gap:34px}.av2-rules li{margin:8px 0;color:#4c5e4e}.av2-nav{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;margin:30px 0 56px}.av2-nav a{padding:12px;border:1px solid var(--line);border-radius:13px;background:white;color:var(--ink)!important;text-decoration:none!important;font-weight:850}.av2-nav span{display:block;color:#806d32;font-size:.65rem}.av2-course{padding:0;border-top:1px solid var(--line)}.av2-course-summary{list-style:none;cursor:pointer;display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:center;padding:36px 0}.av2-course-summary::-webkit-details-marker{display:none}.av2-course-summary>div{max-width:830px}.av2-course-summary p{margin-bottom:0}.av2-course-toggle{display:grid;place-items:center;width:38px;height:38px;border:1px solid var(--line);border-radius:12px;background:#fff;color:var(--g);font-size:1.35rem;font-weight:900}.av2-course[open]>.av2-course-summary .av2-course-toggle{transform:rotate(45deg)}.av2-course-body{padding:0 0 44px}.av2-course-actions{display:flex;justify-content:flex-end;margin:-8px 0 16px}.av2-course-actions>a{color:var(--g)!important;font-weight:900;text-decoration:none!important;white-space:nowrap}.av2-boundary{display:flex;gap:12px;margin:18px 0;padding:13px 15px;border-left:4px solid var(--gold);background:#fff8e7;border-radius:10px}.av2-units{display:grid;grid-template-columns:repeat(5,1fr);gap:9px}.av2-unit{padding:15px;background:var(--p);border:1px solid var(--line);border-radius:15px}.av2-unit p{font-size:.9rem;margin:0}.av2-verify{border-top:1px solid var(--line);margin-top:11px;padding-top:9px}.av2-verify b{display:block;color:#806d32;font-size:.68rem;text-transform:uppercase}.av2-verify span{display:block;color:#536255;font-size:.84rem;margin-top:4px}.av2-practice{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:12px}.av2-exercise,.av2-capstone{padding:16px;border-radius:15px;background:#f0f5ec;border:1px solid var(--line)}.av2-capstone{background:linear-gradient(145deg,#17321d,#2c512f);color:white;border:0}.av2-capstone p{color:#d6e2d4}.av2-capstone small{color:var(--gold)}.av2-check{margin-top:11px;padding:0 16px;background:white;border:1px solid var(--line);border-radius:14px}.av2-check summary{padding:14px 0;font-weight:900;cursor:pointer}.av2-check ul{columns:2}.av2-support{margin-top:38px;padding:27px;border-radius:22px;background:linear-gradient(145deg,#142c18,#29482a);color:white}.av2-support p{color:#d1ddd0}.av2-links{display:grid;grid-template-columns:repeat(3,1fr);gap:9px}.av2-links a{padding:12px;border-radius:12px;background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.15);color:white!important;text-decoration:none!important;font-weight:850}@media(max-width:1050px){.av2-units{grid-template-columns:repeat(2,1fr)}.av2-nav{grid-template-columns:repeat(3,1fr)}}@media(max-width:800px){.av2-hero,.av2-practice,.av2-links{grid-template-columns:1fr}.av2-rules ol,.av2-check ul{columns:1}}
@media(max-width:620px){
.av2{padding:24px 0 56px;font-size:16.5px}
.av2-wrap{width:min(100% - 28px,1200px)}
.av2-hero{gap:16px}
.av2 h2{font-size:clamp(2rem,10vw,3rem);line-height:.98}
.av2 h3{font-size:clamp(1.35rem,7vw,1.85rem);line-height:1.08}
.av2 p,.av2 li{line-height:1.6}
.av2-stats{grid-template-columns:repeat(4,minmax(0,1fr));gap:5px;padding:10px;border-radius:14px}
.av2-stats>div{text-align:center;padding:7px 3px}
.av2-stats b{font-size:1.25rem}
.av2-stats span{display:block;font-size:.66rem;line-height:1.2}
.av2-rules{margin:18px 0;padding:16px;border-radius:14px}
.av2-rules h3{font-size:1.35rem}
.av2-rules ol{padding-left:21px}
.av2-nav{display:flex;grid-template-columns:none;gap:7px;margin:18px 0 28px;overflow-x:auto;scroll-snap-type:x proximity;scrollbar-width:none;padding-bottom:3px}
.av2-nav::-webkit-scrollbar{display:none}
.av2-nav a{flex:0 0 min(76vw,270px);scroll-snap-align:start;min-height:56px;padding:10px 12px;border-radius:12px}
.av2-course-summary{padding:20px 0;gap:10px}
.av2-course-summary h3{font-size:1.3rem}
.av2-course-summary p{font-size:.92rem;line-height:1.5}
.av2-course-toggle{width:34px;height:34px;border-radius:10px}
.av2-course-body{padding:0 0 26px}
.av2-course-actions{justify-content:stretch;margin:0 0 12px}
.av2-course-actions a{display:flex;width:100%;min-height:46px;align-items:center;justify-content:center;border:1px solid var(--line);border-radius:11px;background:#fff;white-space:normal;text-align:center}
.av2-boundary{display:block;margin:12px 0;padding:12px 13px;font-size:.88rem;line-height:1.5}
.av2-boundary b{display:block;margin-bottom:4px}
.av2-units{grid-template-columns:1fr;gap:8px}
.av2-unit{padding:14px;border-radius:13px}
.av2-unit h4{font-size:1.05rem}
.av2-unit p{font-size:.94rem;line-height:1.55}
.av2-verify span{font-size:.82rem;line-height:1.48}
.av2-practice{gap:8px;margin-top:9px}
.av2-exercise,.av2-capstone{padding:14px;border-radius:13px}
.av2-check{padding:0 13px;border-radius:12px}
.av2-check summary{min-height:46px;display:flex;align-items:center}
.av2-support{margin-top:28px;padding:18px;border-radius:16px}
.av2-links{gap:7px}
.av2-links a{min-height:46px;display:flex;align-items:center}
}
</style>`;
