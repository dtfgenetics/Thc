...
@media(max-width:900px){.lhv3-layout{grid-template-columns:1fr}.lhv3-sidebar{display:none}.lhv3-mobile-outline{display:block;background:#fff;border:1px solid var(--line);border-radius:14px;padding:12px 14px;margin-bottom:16px}.lhv3-grid{grid-template-columns:1fr}.lhv3-lesson-row{grid-template-columns:58px 1fr}.lhv3-lesson-row>a{grid-column:2}.lhv3-nextprev{grid-template-columns:1fr}.lhv3-nextprev a:last-child{text-align:left}}
