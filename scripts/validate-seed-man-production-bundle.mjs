...
const markerSets=[
  ...
  ['campaign-ui-v20.js',['seed-man-campaign-ui-v20','seed-man-scoreboard-v1','function tickCompletion','function selectNextLevel','dtf-seed-man-high-scores-v1']],
  ...
  ['canvas-compat-v1.js',['seed-man-runtime-health-v20','campaignTarget: 20','legacyDynamicLoader: false','legacyCanvasMonkeyPatch: false']],
...
for(const marker of ['20260909-v20-runtime-v5','20-Level Campaign','three-world-v1.js','three-world-adapter-v1.js','campaign-v20-runtime.js','campaign-ui-v20.js','v20-enemy-runtime.js','combat-browser-v2.js','enemy-attacks-browser-v2.js','player-state-v20.js','id="next-level"','id="scoreboard-body"','High Scores','seed-man.css?v=20260911-v20-runtime-v6'])if(!index.includes(marker))throw new Error(`index-production-marker-missing:${marker}`);
