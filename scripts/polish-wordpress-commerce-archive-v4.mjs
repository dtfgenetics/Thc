...
body.woocommerce-shop ul.products li.product img,body.post-type-archive-product ul.products li.product img{aspect-ratio:1/1!important;border-radius:20px!important;box-shadow:inset 0 0 0 1px rgba(17,43,28,.06)!important;transition:transform .28s ease,filter .28s ease!important}
