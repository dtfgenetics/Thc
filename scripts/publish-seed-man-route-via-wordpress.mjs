...
for(const marker of ['seed-man-world-mechanics-browser-v1','seed-man-world-mechanics-runtime-v1','moving-platforms','collapsing-platforms','conveyor-platforms','heat-updraft'])if(!worldMechanicsText.includes(marker))throw new Error(`Seed Man world mechanics runtime missing marker: ${marker}`);
...
add_action('rest_api_init', function () {
  ...
  register_rest_route($ns, '/publish', [
    ...
    'callback' => static function(WP_REST_Request $r) use ($token,$allowed,$retired,$purge,$remove) {
      ...
      return rest_ensure_response(['ok'=>true,'route'=>'/games/seed-man-platformer/','files'=>$written,'server_verified'=>true,'campaign_levels'=>20,'worlds'=>5,'final_boss'=>'blight-king','approved_art'=>true,'world_renderer'=>'seed-man-three-world-v2','world_mechanics'=>'seed-man-world-mechanics-browser-v1','dynamic_platforms'=>'seed-man-three-dynamic-platforms-v1','legacy_sprout_run'=>false,'corrupt_master_atlas'=>false,'player_state'=>'v20','combat_runtime'=>'v2','published_at'=>gmdate('c')]);
    }
  ]);
});
`.trim();
