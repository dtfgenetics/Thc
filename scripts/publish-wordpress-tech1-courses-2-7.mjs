...
function renderAssessment(course,assessment,label){
  ...
  return shell(`${crumbs(course,label)}<header class="t1c-hero"><span class="t1c-k">Course ${course.number} · ${esc(label)}</span><h1>${esc(assessment.title)}</h1><p>Complete each item before opening the answer panel. Use missed rationales to return to the matching lesson.</p></header><div class="t1c-boundary"><strong>Assessment boundary:</strong> This is a public learning assessment, not the secure professional certification examination.</div><section class="t1c-section">${qs}</section>`);
}
