...
app.machineData = {
  release: '20260918-v20-world-mechanics-v3',
  ...
  worldMechanicsRuntime: 'seed-man-world-mechanics-browser-v3',
...
if (verified.machineData?.release !== '20260918-v20-world-mechanics-v3') throw new Error('Unexpected Seed Man world-mechanics release marker.');
...
if (verified.machineData?.worldMechanicsRuntime !== 'seed-man-world-mechanics-browser-v3') throw new Error('Seed Man browser world-mechanics runtime was not recorded.');
