...
.v3 .wrap,.dtf-page .dtf-wrap,.game-hub-page .wrap,body:has(.tool-chooser) .wrap,.dtf-footer-v3 .inner{width:calc(100% - (var(--dtf-mobile-gutter) * 2))!important}
.v3 .hero,.dtf-page .dtf-hero{padding-block:clamp(36px,10vw,52px)!important}
.v3 .hero h1,.dtf-page .dtf-hero h1,.game-hub-page .hero h1{font-size:clamp(2.15rem,10vw,3.25rem)!important;line-height:.98!important;letter-spacing:-.045em!important;text-wrap:balance!important}
.v3 .lede,.dtf-page .dtf-lede,.game-hub-page .hero p,body:has(.tool-chooser) .hero p{font-size:1rem!important;line-height:1.58!important}
.v3 .section,.dtf-page .dtf-section,.game-hub-page .content,body:has(.tool-chooser) .section{padding-block:var(--dtf-mobile-section)!important}
.v3 .heading,.dtf-page .dtf-heading,.game-hub-page .section-heading,body:has(.tool-chooser) .section-heading{margin-bottom:22px!important;gap:10px!important}
.v3 .heading h2,.dtf-page .dtf-heading h2,.game-hub-page .section-heading h2,body:has(.tool-chooser) .section-heading h2{font-size:clamp(1.75rem,8vw,2.5rem)!important;line-height:1.02!important}
.v3 :where(p,li),.dtf-page :where(p,li),.lhv3 :where(p,li),.game-hub-page :where(p,li),body:has(.tool-chooser) :where(p,li){font-size:1rem!important;line-height:1.58!important}
.v3 .feature,.v3 .release,.v3 .path,.v3 .lesson,.v3 .visual,.dtf-page .dtf-card,.dtf-page .dtf-path-card,.dtf-page .dtf-flow>article,.game-hub-page .card,body:has(.tool-chooser) .tool-feature,body:has(.tool-chooser) .flow>article{border-radius:var(--dtf-mobile-radius)!important;box-shadow:0 8px 20px rgba(12,39,23,.07)!important}
.v3 .feature-copy,.v3 .release-copy,.v3 .path,.v3 .lesson,.dtf-page .dtf-card-copy,.dtf-page .dtf-path-card,.dtf-page .dtf-flow>article,.game-hub-page .card,body:has(.tool-chooser) .tool-feature,body:has(.tool-chooser) .flow>article{padding:18px!important}
.v3 .actions,.dtf-page .dtf-actions,.game-hub-page .actions,body:has(.tool-chooser) .actions{gap:9px!important}
.v3 .actions>*,.dtf-page .dtf-actions>*,.game-hub-page .actions>*,body:has(.tool-chooser) .actions>*{min-height:48px!important;border-radius:12px!important}
...
.dtf-page :where(figure,picture),.v3 :where(figure,picture),.lhv3 :where(figure,picture){max-width:100%!important;margin-inline:0!important}
.dtf-page :where(img,video),.v3 :where(img,video),.lhv3 :where(img,video){max-width:100%!important;height:auto!important}
...
.v3 .hero h1,.dtf-page .dtf-hero h1,.game-hub-page .hero h1{font-size:clamp(2rem,10.5vw,2.8rem)!important}
.v3 .feature-copy,.v3 .release-copy,.v3 .path,.v3 .lesson,.dtf-page .dtf-card-copy,.dtf-page .dtf-path-card,.dtf-page .dtf-flow>article,.game-hub-page .card,body:has(.tool-chooser) .tool-feature,body:has(.tool-chooser) .flow>article{padding:16px!important}
}
