...
const header=`<!-- wp:html -->${shellStyle}<header class="dtf-shell-v3" data-dtf-shell="header-v3" data-dtf-shell-version="4"><div class="dtf-shell-v3-inner">${brandLink}<button class="dtf-shell-menu" type="button" aria-expanded="false" aria-controls="dtf-primary-nav">Menu</button><nav id="dtf-primary-nav" class="dtf-shell-nav" aria-label="Primary navigation"><a href="/">Home</a><a href="/seeds/">Seeds</a><a href="/learn/">Learn</a><a href="/courses/">Courses</a><a href="/tools/">Tools</a><a href="/games/">Games</a><a href="/community/">Community</a><a class="shop" href="/shop/">Shop</a></nav><div class="dtf-shell-utility"><span class="dtf-shell-thc">Teaching Healthy<br>Cultivation</span><div class="dtf-shell-icons"><a class="dtf-shell-icon" href="/?s=" aria-label="Search DTF Genetics">${searchIcon}</a><a class="dtf-shell-icon" href="/my-account/" aria-label="Account">${userIcon}</a><a class="dtf-shell-icon" href="/cart/" aria-label="Cart">${cartIcon}</a></div></div></div></header>${headerScript}<!-- /wp:html -->`;
