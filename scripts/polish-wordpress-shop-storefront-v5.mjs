    ...
    try {
      const response = await fetch(`${siteUrl}${path}`, {
        ...
        headers: {
          ...
          'User-Agent': 'DTFSeeds-Shop-Storefront-V5/1.2',
...
<article class="dtf-shop-v5-compare" data-review-file="${esc(card.fileName)}">
  <a class="dtf-shop-v5-compare-art" href="${esc(lineRoute)}" aria-label="Read ${esc(name)} breeding notes">
  ...
  <div class="dtf-shop-v5-compare-copy">
    <small>${esc(label)}</small>
    <h3>${esc(name)}</h3>
    <p class="dtf-shop-v5-lineage">${esc(lineage)}</p>
    <p>${esc(note)}</p>
    <div class="dtf-shop-v5-compare-actions">
      <a href="${esc(lineRoute)}">Breeding notes</a>
      <a href="${esc(productRoute)}">View store listing</a>
    </div>
  </div>
</article>`).join('');
...
<section class="dtf-shop-storefront-v5" data-dtf-shop-storefront-v5="true" data-dtf-shop-visual="premium-v6" data-dtf-shop-structure="context-first-v7" aria-labelledby="dtf-shop-v5-title">
<style id="dtf-shop-storefront-v5-style">
body:has(.dtf-shop-storefront-v5) .woocommerce-products-header__title.page-title,body:has(.dtf-shop-storefront-v5) .wp-block-query-title{display:none!important}
...
.dtf-shop-storefront-v5 *{box-sizing:border-box}.dtf-shop-v5-hero{display:grid;grid-template-columns:minmax(0,1.25fr) minmax(280px,.75fr);gap:clamp(34px,6vw,82px);align-items:center;max-width:1180px;margin:0 auto}.dtf-shop-v5-kicker{display:inline-flex;align-items:center;gap:10px;margin:0 0 16px;color:#efd47f;font-size:.7rem;font-weight:950;letter-spacing:.15em;text-transform:uppercase}.dtf-shop-v5-kicker:before{content:"";width:28px;height:1px;background:#d5b15a}.dtf-shop-storefront-v5 h1{max-width:790px;margin:0;font-family:"Arial Narrow","Roboto Condensed",Inter,sans-serif;font-size:clamp(3rem,6.4vw,6.2rem);line-height:.88;letter-spacing:-.045em;text-transform:uppercase;color:#fff;text-wrap:balance}.dtf-shop-v5-lede{max-width:720px;margin:20px 0 0;color:#c9d7ce;font-size:clamp(1rem,1.35vw,1.13rem);line-height:1.7}.dtf-shop-v5-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:24px}.dtf-shop-v5-actions a{display:inline-flex;align-items:center;justify-content:center;min-height:46px;padding:10px 16px;border:1px solid rgba(213,177,90,.42);border-radius:9px;background:rgba(255,255,255,.035);color:#fff!important;text-decoration:none!important;text-transform:uppercase;font-size:.69rem;font-weight:950;letter-spacing:.065em;transition:transform .18s ease,border-color .18s ease,background .18s ease}.dtf-shop-v5-actions a:hover{transform:translateY(-2px);border-color:#dfc16e;background:rgba(213,177,90,.09)}.dtf-shop-v5-actions a:first-child{border-color:#dfc16e;background:linear-gradient(180deg,#d9ba68,#b89238);color:#07170f!important}.dtf-shop-v5-featured{position:relative;width:min(390px,100%);justify-self:end;padding:13px;border:1px solid rgba(213,177,90,.35);border-radius:26px;background:linear-gradient(145deg,rgba(255,255,255,.07),rgba(255,255,255,.015));box-shadow:0 34px 78px rgba(0,0,0,.34);transform:rotate(1deg)}.dtf-shop-v5-featured:before{content:"CURRENT RELEASE";position:absolute;left:-18px;top:28px;z-index:2;padding:7px 10px;border:1px solid rgba(213,177,90,.52);border-radius:7px;background:#07170f;color:#efd47f;font-size:.58rem;font-weight:950;letter-spacing:.13em}.dtf-shop-v5-featured img{display:block;width:100%;aspect-ratio:2/3;object-fit:cover;border-radius:17px;background:#081a11}.dtf-shop-v5-trust{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));max-width:1180px;margin:clamp(40px,6vw,70px) auto 0;border-top:1px solid rgba(255,255,255,.12);border-bottom:1px solid rgba(255,255,255,.12)}.dtf-shop-v5-trust div{padding:17px 16px;border-right:1px solid rgba(255,255,255,.1)}.dtf-shop-v5-trust div:last-child{border-right:0}.dtf-shop-v5-trust small{display:block;color:#91a79a;font-size:.61rem;font-weight:900;letter-spacing:.1em;text-transform:uppercase}.dtf-shop-v5-trust strong{display:block;margin-top:5px;color:#f4f0e5;font-size:.86rem;line-height:1.3}.dtf-shop-v5-section-head{max-width:1180px;margin:clamp(54px,7vw,84px) auto 24px}.dtf-shop-v5-section-head p{margin:0 0 8px;color:#dabb61;font-size:.66rem;font-weight:950;letter-spacing:.13em;text-transform:uppercase}.dtf-shop-v5-section-head h3{max-width:720px;margin:0;color:#fff;font:900 clamp(2rem,4vw,3.8rem)/.96 "Arial Narrow","Roboto Condensed",Inter,sans-serif;text-transform:uppercase;letter-spacing:-.025em}.dtf-shop-v5-guide{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;max-width:1180px;margin:0 auto}.dtf-shop-v5-compare{display:grid;grid-template-columns:92px minmax(0,1fr);gap:15px;align-items:start;padding:12px;border:1px solid rgba(151,183,158,.2);border-radius:16px;background:rgba(10,34,21,.72);box-shadow:0 12px 30px rgba(0,0,0,.12);transition:transform .18s ease,border-color .18s ease}.dtf-shop-v5-compare:hover{transform:translateY(-3px);border-color:rgba(213,177,90,.5)}.dtf-shop-v5-compare-art{display:block;overflow:hidden;border:1px solid rgba(255,255,255,.08);border-radius:10px;background:#07170f}.dtf-shop-v5-compare-art img{display:block;width:100%;aspect-ratio:2/3;object-fit:cover;object-position:center top}.dtf-shop-v5-compare-copy{min-width:0;padding:3px 3px 3px 0}.dtf-shop-v5-compare small{display:block;margin-bottom:6px;color:#efd47f;font-size:.61rem;font-weight:950;letter-spacing:.1em;text-transform:uppercase}.dtf-shop-v5-compare h3{margin:0 0 6px;color:#fff;font:900 clamp(1.2rem,2vw,1.55rem)/1 "Arial Narrow","Roboto Condensed",Inter,sans-serif;text-transform:uppercase}.dtf-shop-v5-compare p{margin:0 0 7px;color:#aebfb4;font-size:.79rem;line-height:1.45}.dtf-shop-v5-compare .dtf-shop-v5-lineage{color:#dfe7e1;font-weight:800}.dtf-shop-v5-compare-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:10px}.dtf-shop-v5-compare-actions a{color:#efd47f!important;font-size:.68rem;font-weight:900;text-decoration:none!important;text-transform:uppercase;letter-spacing:.04em}.dtf-shop-v5-compare-actions a+ a{color:#b9c9bf!important}.dtf-shop-v5-store-handoff{max-width:1180px;margin:clamp(46px,6vw,72px) auto 0;padding:24px clamp(18px,3vw,30px);border:1px solid rgba(213,177,90,.28);border-radius:18px;background:linear-gradient(135deg,rgba(213,177,90,.08),rgba(255,255,255,.025))}.dtf-shop-v5-store-handoff p:first-child{margin:0 0 6px;color:#dabb61;font-size:.65rem;font-weight:950;letter-spacing:.13em;text-transform:uppercase}.dtf-shop-v5-store-handoff h3{margin:0;color:#fff;font:900 clamp(1.75rem,3.2vw,2.75rem)/1 "Arial Narrow","Roboto Condensed",Inter,sans-serif;text-transform:uppercase}.dtf-shop-v5-store-handoff p:last-child{max-width:760px;margin:10px 0 0;color:#aebfb4;line-height:1.6}.dtf-shop-v5-note{max-width:920px;margin:20px auto 0;color:#91a79a;font-size:.8rem;line-height:1.58}.dtf-shop-storefront-v5 a:focus-visible{outline:3px solid #efd47f;outline-offset:4px}
@media(max-width:880px){.dtf-shop-v5-hero{grid-template-columns:1fr}.dtf-shop-v5-featured{justify-self:start;width:min(350px,82vw);transform:none}.dtf-shop-v5-trust{grid-template-columns:repeat(2,minmax(0,1fr))}.dtf-shop-v5-trust div:nth-child(2){border-right:0}.dtf-shop-v5-trust div:nth-child(-n+2){border-bottom:1px solid rgba(255,255,255,.1)}.dtf-shop-v5-guide{grid-template-columns:1fr}.dtf-shop-v5-compare{grid-template-columns:108px minmax(0,1fr)}}
@media(max-width:600px){.dtf-shop-storefront-v5{padding:54px 16px 62px}.dtf-shop-storefront-v5 h1{font-size:clamp(2.8rem,15vw,4.5rem)}.dtf-shop-v5-actions a{width:100%}.dtf-shop-v5-featured{width:min(330px,88vw)}.dtf-shop-v5-featured:before{left:12px;top:12px}.dtf-shop-v5-trust{grid-template-columns:1fr}.dtf-shop-v5-trust div,.dtf-shop-v5-trust div:nth-child(2){border-right:0;border-bottom:1px solid rgba(255,255,255,.1)}.dtf-shop-v5-trust div:last-child{border-bottom:0}.dtf-shop-v5-compare{grid-template-columns:76px minmax(0,1fr);gap:12px;padding:10px}.dtf-shop-v5-compare p:not(.dtf-shop-v5-lineage){display:none}.dtf-shop-v5-compare-actions{gap:8px}.dtf-shop-v5-store-handoff{padding:20px 16px}}
@media(prefers-reduced-motion:reduce){.dtf-shop-storefront-v5 *{transition:none!important}.dtf-shop-v5-compare:hover,.dtf-shop-v5-actions a:hover{transform:none!important}}
</style>
<div class="dtf-shop-v5-hero">
  <div>
    <p class="dtf-shop-v5-kicker">DTF Genetics · Current releases</p>
    <h1 id="dtf-shop-v5-title">Shop the release. Read the breeding story.</h1>
...
<div class="dtf-shop-v5-section-head"><p>Compare the breeding context</p><h3>Three releases. Two breeding projects.</h3></div>
<div class="dtf-shop-v5-guide" aria-label="Current release comparison">${releaseMarkup}
</div>
<p class="dtf-shop-v5-note">This comparison is for generation, seed type, lineage, and project context. Product pages below remain the source of truth for price, availability, quantity, and checkout terms.</p>
<div class="dtf-shop-v5-store-handoff" id="dtf-current-store-listings"><p>Store listings</p><h3>Price, availability & checkout</h3><p>The WooCommerce listings below are the transactional layer. Use them for current pricing, stock, pack details, and cart actions.</p></div>
</section>
<!-- /wp:html -->`;
...
if (apply) {
  ...
  if (!saved.includes('data-dtf-shop-structure="context-first-v7"')) throw new Error('Shop context-first structure marker did not persist.');
  if (!saved.includes('Price, availability & checkout')) throw new Error('Shop transactional handoff did not persist.');
  if (!saved.includes('<h1 id="dtf-shop-v5-title">Shop the release. Read the breeding story.</h1>')) throw new Error('Shop V5 semantic H1 did not persist.');
...
const report = {
  ...
  structureMarker: 'data-dtf-shop-structure="context-first-v7"',
  semanticHeading: 'h1',
