...
This file is the durable scope ledger for DTF Genetics games. A title should not disappear from planning simply because it is not yet on the public Game Hub.
...
4. THC Weekly Crossword
5. Who Took It?
6. Grower Conversations
7. Terpocalypse: Grow Room From Hell
8. High Life: From Bagseed to Legacy
9. Weedopolis: Strain City Edition
10. Strain Showdown
11. PhenoQuest: The Living Seed Vault
12. Bud or Bluff
13. Burn Buds
14. THC U Know
15. Kush Kings Chess
...
3. **Lost in the Terps** — themed word-search missions such as Gas Station Sesh, Grow Room Panic, and Terp Jungle.
4. **Spin the Strain** — wheel-driven strain picker, trivia/challenge selector, giveaway picker, or event reward game.
5. **Mystery Strain** — yes/no strain-trait deduction game with optional wild-card modifiers.
6. **High Lines** — interactive cannabis coloring/activity experience with trippy grow rooms, fantasy gardens, hidden objects, prompts, and creative activities.
7. **Grow Room Defense** — defend plants from pests/pathogens using IPM tools and correct counterplay.
8. **Harvest Hustle** — time-management harvest/trim arcade game.
9. **Pheno Draft** — roguelike genetics deck-builder centered on selection and breeding decisions.
10. **Trichome Trials** — judge/scorecard game using Structure, Resin, Terps, Yield, Color, Documentation, and Problem Solving.

## Future concept bank

These earlier concepts are preserved as a secondary backlog rather than silently lost: Root Cause, Pheno Hunter, Pest Patrol, Solo Cup Showdown, The Cure Room, Seed Bank Builder, Keeper or Compost, Grow Shop Hustle, Event Night, Find/Where’s Seed Man, Grow-Off, The Grow Room, Pest War, Line Builder, Selection Pressure, Pest Siege, Reputation Economy, The Limiting Factor, and The Perfect Save.
...
1. Strain Match
2. Grow Room Bingo / Bongwater Bingo
3. Lost in the Terps
4. Mystery Strain
5. Spin the Strain
6. Grow Room Defense
