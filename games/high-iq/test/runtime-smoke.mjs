...
assert.match(app, /hiq-pulse-question/, 'question transitions must replay the stage cue');
...
assert.match(focusCss, /High IQ v3\.6 — stage feedback/);
assert.match(focusCss, /data-hiq-stage/);
assert.match(focusCss, /hiq-correct-stage/);
assert.match(focusCss, /hiq-incorrect-stage/);
