...
assert.match(app, /history\.replaceState/, 'runtime must preserve shareable mission URLs');
...
console.log('Lost in the Terps public runtime regression checks passed.');
